...
CREATE TABLE `compras` (
  ...
  CONSTRAINT `compras_ibfk_2` FOREIGN KEY (`carrito_id`) REFERENCES `cart` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `products_cart` (
  ...
  CONSTRAINT `products_cart_ibfk_2` FOREIGN KEY (`carrito_id`) REFERENCES `cart` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `users` VALUES (1,'Fran','locane','Arregui 6074',1408,'locane.francisco@gmail.com',NULL,NULL,'$2y$10$sS9OKM9crpH.ygkfdkiZVOGdlCgK1Mhw7/73iUrZa.DUgzt3f0xAW',NULL,'2019-12-17 22:44:57','2019-12-17 23:13:47',9),(2,'yohana',NULL,NULL,NULL,'yoha@yoha.com',NULL,NULL,'$2y$10$0n1vtAuhagojnOckpcR1xOkHjWN8n/U12QFcY2.lTSlAQzupFrJq6',NULL,'2019-12-20 01:51:48','2019-12-20 01:51:48',NULL);
...
-- Dump completed on 2019-12-20 14:37:04
