...
<div class="formDatosEditPerf">
        
        
        <form  action="/users/update/{{$user->id}}" method="POST" enctype="multipart/`form-data">

            @csrf
            <p class="gssFontProf2">Actualizar mis Datos</p>
            <div class="gssform-group"> <!-- Nombre -->
            ...
            <div class="gssform-group"> <!-- Apellido -->
            ...
            <div class="gssform-group"><!-- E-mail -->
            ...
            <div class="gssform-group"> <!-- Zipcode -->
            ...
            <div class="gssform-group"><!-- adress -->
            ...
            <div class="gssform-group"><!-- Provincia -->
                <label for="provincia" class="control-label">Provincia</label>
                <input id="provincia" type="provincia" class="form-control" name="provincia" value="" required autocomplete="provincia" placeholder="Ingresa tu provincia">
            </div>

            <div class="gssform-group"><!-- Localidad -->
                <label for="localidad" class="control-label">Localidad</label>
                <input id="localidad" type="Localidad" class="form-control" name="localidad" value="" required autocomplete="localidad" placeholder="Ingresa tu localidad">
            </div>

            @if(auth()->user() && auth()->user()->rol == 9)
            <div class="gssform-group"><!-- ROL -->
            ...
            <div class="bar">
                ...
                <button type="submit" class='btn btn-outline-secondary botonEdit'> Actualizar </button>
                <a href="{{url('perfil')}}">
                <button type="button" class='btn btn-outline-secondary botonEdit'><-Volver</button></a>
        </form>
