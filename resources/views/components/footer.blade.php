<footer class= "foot p-3 footLayout">
    <div class="row mx-0">
      <div class=" col-12 col-md-4 border-right border-white">
        <h4 class="foot">Informacion de interes</h4>
        <div>
        ...
        <div class="col-12 col-md-4 border-right border-white">
          <h4  class="foot"><h4 class="foot">Servicios</h4></h4>
          <p class="iconos">
        ...
        <div class="d-none d-md-block col-md-4 ">
                <h4  class="foot"><h4 class="foot">Ubicacion</h4></h4>
